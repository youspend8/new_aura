...
<body>
				...
				<div class="card fat">
					<div class="card-body">
						...
						<div class="tab" style="width: 100%;">
							<button class="tablinks w-50"
								onclick="findThing(event, 'id_find')" id="defaultOpen">
								<div>아이디 찾기</div>
							</button>
							<button class="tablinks w-50"
								onclick="findThing(event, 'pw_find')">
								<div>비밀번호 찾기</div>
							</button>
						</div>
								...
								<form method="POST" class="my-login-validation" novalidate="">
									<div class="custom-control custom-radio">
										<input type="radio" class="custom-control-input"
											...
											onclick="Radio_OnOff('test1')" checked> <label
											class="custom-control-label" for="defaultGroupExample1">회원정보에
											등록한 휴대전화로 인증</label>
										...
										<div class="form-group" id="test1">
											...
											<div class="md-form flex-column flex-sm-row"
												style="display: flex;">
												<input type="text" class="form-control col-sm-8 col-12"
													id="identified_phone"> <label
													for="identified_phone">휴대폰 *</label>
											...
											<div class="md-form flex-column flex-sm-row"
												style="display: flex;">
												<input type="text" class="form-control col-sm-8 col-12"
													id="identified_number_idphone"> <label
													for="identified_number_idphone">인증번호*</label>
								...
								<form method="POST" class="my-login-validation" novalidate="">
									<div class="custom-control custom-radio">
										<input type="radio" class="custom-control-input"
											...
											onclick="Radio_OnOff('test2')"> <label
											class="custom-control-label" for="defaultGroupExample2">본인확인
											이메일로 인증</label>
										<div class="form-group" id="test2" style="display: none;">
											...
											<div class="md-form flex-column flex-sm-row"
												style="display: flex;">
												<input type="text" class="form-control col-sm-8 col-12"
													id="identified_email"> <label
													for="identified_email">인증번호 받을 이메일주소를 적어주세요 *</label>
												<button class="btn btn-primary btn-sm" id="duplicate">인증번호</button>
											</div>
											...
											<div class="md-form flex-column flex-sm-row"
												style="display: flex;">
												<input type="text" class="form-control  col-sm-8 col-12"
													id="identified_number_idemail"> <label
													for="identified_number_idemail">인증번호*</label>
						...
						<div id="pw_find" class="tabcontent" value="pw_find">
								...
								<form method="POST" class="my-login-validation" novalidate="">
									...
									<div class="custom-control custom-radio">
										<input type="radio" class="custom-control-input"
											...
											onclick="Radio_OnOff2('test3')" checked> <label
											class="custom-control-label" for="defaultGroupExample3">회원정보에
											등록한 휴대전화로 인증</label>
										...
										<div class="form-group" id="test3">
											...
											<div class="form-group">
												<div class="md-form">
													<input type="text" class="form-control"
														id="input_name_pwfind"> <label
														for="input_name_pwfind">이름 *</label>
												</div>
												<div class="invalid-feedback">이름 입력이 필요합니다.</div>
											</div>
											...
											<div class="md-form flex-column flex-sm-row"
												style="display: flex;">
												<input type="text" class="form-control  col-sm-8 col-12 "
													id="identified_phone_pw"> <label
													for="identified_phone_pw">휴대폰 *</label>
												<button class="btn btn-primary btn-sm" id="duplicate">인증번호</button>
											</div>
											...
											<div class="md-form flex-column flex-sm-row"
												style="display: flex;">
												<input type="text" class="form-control  col-sm-8 col-12"
													id="identified_number_idphone_pw"> <label
													for="identified_number_idphone_pw">인증번호*</label>
												<button type="button" class="btn btn-primary btn-sm"
													id="duplicate3">확인</button>
											</div>
									...
									<form method="POST" class="my-login-validation" novalidate="">
										<div class="custom-control custom-radio">
											<input type="radio" class="custom-control-input"
												...
												onclick="Radio_OnOff2('test4')"> <label
												class="custom-control-label" for="defaultGroupExample4">본인확인
												이메일로 인증</label>
											<div class="form-group" id="test4" style="display: none;">
												...
												<div class="md-form flex-column flex-sm-row"
													style="display: flex;">
													<input type="text" class="form-control  col-sm-8 col-12"
														id="identified_email_pw"> <label
														for="identified_email_pw">이메일 *</label>
													<button class="btn btn-primary btn-sm" id="duplicate">인증번호</button>
												</div>
												...
												<div class="md-form flex-column flex-sm-row"
													style="display: flex;">
													<input type="text" class="form-control  col-sm-8 col-12"
														id="identified_number_idemail_pw"> <label
														for="identified_number_idemail_pw">인증번호*</label>
													<button type="" class="btn btn-primary btn-sm"
														id="duplicate4">확인</button>
												</div>
							...
							<button type="button"
								class="btn btn-outline-primary waves-effect"
								style="width: 100%; height: 46px; margin: 10px auto"
								data-toggle="modal" data-target="#pw_renew">다음 단계로</button>

							<div class="modal fade " id="pw_renew" tabindex="-1"
								role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
								<div class="modal-dialog modal-dialog-centered" role="document">
									<div class="modal-content">
										<div class="modal-header primary-color #4285F4">
											<h5 class="modal-title white-text" id="exampleModalLabel">비밀번호
												변경</h5>
											...
											<div class="form-group text-center"
												...
												<div class="md-form text-left" style="margin: 0px;">
													<input type="password" class="form-control"
														id="password_find"> <label for="password_find">비밀번호
														*</label>
												</div>
												...
												<div class="md-form text-left">
													<input type="password" class="form-control"
														id="password_find_confirm"> <label
														for="password_find_confirm">비밀번호 확인 *</label>
												</div>
												<div class="invalid-feedback">비밀번호 입력이 필요합니다.</div>
										...
										<div class="modal-footer flex "
											...
											<button type="button"
												class="btn btn-outline-primary waves-effect col-5"
												data-dismiss="modal">Close</button>
											<button type="button" class="btn btn-primary col-7"
												id="duplicate">비밀번호 변경</button>
										</div>
	...
	<script>
		function Radio_OnOff(type) {
			if (type == 'test1') {
				document.g
		etElementById(type).style.display = '';
